...
module.exports = function() {
		...
		filterType(variable, name, node) {
			...
			if(variable.type) {
				if(variable.type.properties) {
					for(var __ks_0 = 0, __ks_1 = variable.type.properties.length, property; __ks_0 < __ks_1; ++__ks_0) {
						property = variable.type.properties[__ks_0];
					...
					if(data.callee.kind === Kind.Identifier) {
						...
						if(Type.isArray(variable)) {
							for(var __ks_1 = 0, __ks_2 = variable.length, vari; __ks_1 < __ks_2; ++__ks_1) {
								...
								for(var __ks_3 = 0, __ks_4 = vari.instanceMethods[name].length, member; __ks_3 < __ks_4; ++__ks_3) {
									member = vari.instanceMethods[name][__ks_3];
							...
							if(variable.type && variable.type.properties) {
								for(var __ks_1 = 0, __ks_2 = variable.type.properties.length, property; __ks_1 < __ks_2; ++__ks_1) {
									property = variable.type.properties[__ks_1];
	...
	class Module {
		...
		__ks_cons_0(data, compiler, directory) {
			if(data === undefined || data === null) {
				throw new Error("Missing parameter 'data'");
			}
		...
		__ks_func_toFragments_0() {
			if(this._binary) {
				var builder = new FragmentBuilder(0);
				this._body.toFragments(builder);
				return builder.toArray();
			}
			else {
				var builder = new FragmentBuilder(1);
				this._body.toFragments(builder);
				var fragments = [];
		...
		__ks_func_analyse_0() {
			...
			for(var __ks_0 = 0, __ks_1 = data.declarations.length, declaration; __ks_0 < __ks_1; ++__ks_0) {
				...
				if(__ks_2 === Kind.ClassDeclaration) {
					...
					var continuous = true;
					for(var i = 0, __ks_3 = declaration.modifiers.length; continuous && i < __ks_3; ++i) {
	...
	class ImplementDeclaration extends Statement {
		...
		__ks_func_analyse_0() {
			var data = this._data;
			var variable = this._scope.getVariable(data.class.name);
			if(variable.kind !== VariableKind.Class) {
	...
	class ImplementFieldDeclaration extends Statement {
		...
		__ks_cons(args) {
			if(args.length === 3) {
				ImplementFieldDeclaration.prototype.__ks_cons_0.apply(this, args);
			}
			else {
				Statement.prototype.__ks_cons.call(this, args);
			}
		...
		analyse() {
			if(arguments.length === 0) {
				return ImplementFieldDeclaration.prototype.__ks_func_analyse_0.apply(this);
			}
			else if(Statement.prototype.analyse) {
				return Statement.prototype.analyse.apply(this, arguments);
			}
		...
		fuse() {
			if(arguments.length === 0) {
				return ImplementFieldDeclaration.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Statement.prototype.fuse) {
				return Statement.prototype.fuse.apply(this, arguments);
			}
		...
		toFragments() {
			if(arguments.length === 2) {
				return ImplementFieldDeclaration.prototype.__ks_func_toFragments_0.apply(this, arguments);
			}
			return Statement.prototype.toFragments.apply(this, arguments);
		}
	}
	ImplementFieldDeclaration.__ks_reflect = {
		inits: 0,
		constructors: [
			{
				access: 3,
	...
	class ImplementMethodDeclaration extends Statement {
		...
		__ks_init() {
			Statement.prototype.__ks_init.call(this);
			ImplementMethodDeclaration.prototype.__ks_init_1.call(this);
		}
		__ks_cons_0(data, parent, variable) {
			if(data === undefined || data === null) {
				throw new Error("Missing parameter 'data'");
		...
		__ks_cons(args) {
			if(args.length === 3) {
				ImplementMethodDeclaration.prototype.__ks_cons_0.apply(this, args);
			}
			else {
				Statement.prototype.__ks_cons.call(this, args);
			}
		...
		analyse() {
			if(arguments.length === 0) {
				return ImplementMethodDeclaration.prototype.__ks_func_analyse_0.apply(this);
			}
			else if(Statement.prototype.analyse) {
				return Statement.prototype.analyse.apply(this, arguments);
			}
		...
		fuse() {
			if(arguments.length === 0) {
				return ImplementMethodDeclaration.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Statement.prototype.fuse) {
				return Statement.prototype.fuse.apply(this, arguments);
			}
		...
		toStatementFragments() {
			if(arguments.length === 2) {
				return ImplementMethodDeclaration.prototype.__ks_func_toStatementFragments_0.apply(this, arguments);
			}
			else if(Statement.prototype.toStatementFragments) {
				return Statement.prototype.toStatementFragments.apply(this, arguments);
			}
	...
	ImplementMethodDeclaration.__ks_reflect = {
		inits: 1,
		constructors: [
			{
				access: 3,
	...
	class ImplementMethodAliasDeclaration extends Statement {
		...
		__ks_init() {
			Statement.prototype.__ks_init.call(this);
			ImplementMethodAliasDeclaration.prototype.__ks_init_1.call(this);
		}
		__ks_cons_0(data, parent, variable) {
			if(data === undefined || data === null) {
				throw new Error("Missing parameter 'data'");
		...
		__ks_cons(args) {
			if(args.length === 3) {
				ImplementMethodAliasDeclaration.prototype.__ks_cons_0.apply(this, args);
			}
			else {
				Statement.prototype.__ks_cons.call(this, args);
			}
		...
		analyse() {
			if(arguments.length === 0) {
				return ImplementMethodAliasDeclaration.prototype.__ks_func_analyse_0.apply(this);
			}
			else if(Statement.prototype.analyse) {
				return Statement.prototype.analyse.apply(this, arguments);
			}
		...
		fuse() {
			if(arguments.length === 0) {
				return ImplementMethodAliasDeclaration.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Statement.prototype.fuse) {
				return Statement.prototype.fuse.apply(this, arguments);
			}
		...
		toStatementFragments() {
			if(arguments.length === 2) {
				return ImplementMethodAliasDeclaration.prototype.__ks_func_toStatementFragments_0.apply(this, arguments);
			}
			else if(Statement.prototype.toStatementFragments) {
				return Statement.prototype.toStatementFragments.apply(this, arguments);
			}
	...
	ImplementMethodAliasDeclaration.__ks_reflect = {
		inits: 1,
		constructors: [
			{
				access: 3,
	...
	class ImplementMethodLinkDeclaration extends Statement {
		...
		__ks_init() {
			Statement.prototype.__ks_init.call(this);
			ImplementMethodLinkDeclaration.prototype.__ks_init_1.call(this);
		}
		__ks_cons_0(data, parent, variable) {
			if(data === undefined || data === null) {
				throw new Error("Missing parameter 'data'");
		...
		__ks_cons(args) {
			if(args.length === 3) {
				ImplementMethodLinkDeclaration.prototype.__ks_cons_0.apply(this, args);
			}
			else {
				Statement.prototype.__ks_cons.call(this, args);
			}
		...
		analyse() {
			if(arguments.length === 0) {
				return ImplementMethodLinkDeclaration.prototype.__ks_func_analyse_0.apply(this);
			}
			else if(Statement.prototype.analyse) {
				return Statement.prototype.analyse.apply(this, arguments);
			}
		...
		fuse() {
			if(arguments.length === 0) {
				return ImplementMethodLinkDeclaration.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Statement.prototype.fuse) {
				return Statement.prototype.fuse.apply(this, arguments);
			}
		...
		toStatementFragments() {
			if(arguments.length === 2) {
				return ImplementMethodLinkDeclaration.prototype.__ks_func_toStatementFragments_0.apply(this, arguments);
			}
			else if(Statement.prototype.toStatementFragments) {
				return Statement.prototype.toStatementFragments.apply(this, arguments);
			}
	...
	ImplementMethodLinkDeclaration.__ks_reflect = {
		inits: 1,
		constructors: [
			{
				access: 3,
	...
	class CallFinalExpression extends Expression {
		...
		analyse() {
			if(arguments.length === 0) {
				return CallFinalExpression.prototype.__ks_func_analyse_0.apply(this);
			}
			else if(Expression.prototype.analyse) {
				return Expression.prototype.analyse.apply(this, arguments);
			}
		...
		fuse() {
			if(arguments.length === 0) {
				return CallFinalExpression.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Expression.prototype.fuse) {
				return Expression.prototype.fuse.apply(this, arguments);
			}
		...
		__ks_func_isComputed_0() {
			return Type.isValue(this._callee.variables) && (this._callee.variables.length > 1);
		}
		isComputed() {
			if(arguments.length === 0) {
				return CallFinalExpression.prototype.__ks_func_isComputed_0.apply(this);
			}
			return Expression.prototype.isComputed.apply(this, arguments);
		}
		__ks_func_isNullable_0() {
		...
		isNullable() {
			if(arguments.length === 0) {
				return CallFinalExpression.prototype.__ks_func_isNullable_0.apply(this);
			}
			return Expression.prototype.isNullable.apply(this, arguments);
		}
		__ks_func_toFragments_0(fragments, mode) {
			...
			if(Type.isValue(this._callee.variable)) {
				var path = Type.isValue(this._callee.variable.accessPath) ? this._callee.variable.accessPath + this._callee.variable.final.name : this._callee.variable.final.name;
				if(this._callee.instance) {
					...
					fragments.code(Type.isValue(this._callee.variable.accessPath) ? this._callee.variable.accessPath : "", this._callee.variable.final.name + "._cm_" + this._data.callee.property.name + "(");
					for(var i = 0, __ks_0 = this._arguments.length; i < __ks_0; ++i) {
						if(i) {
							fragments.code($comma);
						}
				...
				fragments.code(") : ");
				fragments.code(callee.variables[1].accessPath || "", callee.variables[1].final.name + "._im_" + data.callee.property.name + "(");
				if(Type.isValue(name)) {
					fragments.code(name);
				}
				else {
		...
		toFragments() {
			if(arguments.length === 2) {
				return CallFinalExpression.prototype.__ks_func_toFragments_0.apply(this, arguments);
			}
			else if(Expression.prototype.toFragments) {
				return Expression.prototype.toFragments.apply(this, arguments);
			}
	...
	CallFinalExpression.__ks_reflect = {
		inits: 1,
		constructors: [
			{
				access: 3,
	...
	$expressions[Kind.MemberExpression] = MemberExpression;
