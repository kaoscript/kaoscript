...
module.exports = function() {
	...
	var Compiler = require("./compiler2.js")().Compiler;
	...
	program.version(metadata.version).usage("[options] <file>").option("-c, --compile", "compile to JavaScript and save as .js files").option("    --no-header", "suppress the \"Generated by\" header").option("-m, --metadata", "write the metadata file").option("-o, --output <path>", "set the output directory for compiled JavaScript").option("-p, --print", "print out the compiled JavaScript").option("    --no-register", "suppress \"require(kaoscript/register)\"").option("-r, --rewire <src-path=gen-path,...>", "rewire the references to source files to generated files", rewire).option("-t, --target <engine>", "set the engine/runtime/browser to compile for").parse(process.argv);
