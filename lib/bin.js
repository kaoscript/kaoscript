...
module.exports = function() {
	...
	if(Type.isValue(program.rewire)) {
		options.rewire = [];
		for(let __ks_0 = 0, __ks_1 = program.rewire.length, item; __ks_0 < __ks_1; ++__ks_0) {
	...
	if(program.compile === true) {
		...
		for(let __ks_0 = 0, __ks_1 = Object.getOwnPropertyNames(require), __ks_2 = __ks_1.length, r; __ks_0 < __ks_2; ++__ks_0) {
			r = __ks_1[__ks_0];
