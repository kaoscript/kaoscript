// Generated by kaoscript undefined
...
module.exports = function() {
	...
	Error.prepareStackTrace = function(error, stack) {
		...
		if(!KSType.is(error, Error)) {
			throw new Error("Invalid type for parameter 'error'");
		}
		if(stack === undefined || stack === null) {
			throw new Error("Missing parameter 'stack'");
		}
		if(!KSType.isArray(stack)) {
			throw new Error("Invalid type for parameter 'stack'");
		}
	...
	var Exception = Helper.class({
		...
		__ks_cons_0: function(message, fileName, lineNumber) {
			...
			if(!KSType.isString(message)) {
				throw new Error("Invalid type for parameter 'message'");
			}
			if(fileName === undefined || fileName === null) {
				throw new Error("Missing parameter 'fileName'");
			}
			if(!KSType.isString(fileName)) {
				throw new Error("Invalid type for parameter 'fileName'");
			}
			if(lineNumber === undefined || lineNumber === null) {
				throw new Error("Missing parameter 'lineNumber'");
			}
			if(!KSType.isNumber(lineNumber)) {
				throw new Error("Invalid type for parameter 'lineNumber'");
			}
		...
		__ks_cons_1: function(message, node) {
			...
			if(!KSType.is(node, AbstractNode)) {
				throw new Error("Invalid type for parameter 'node'");
			}
	...
	var NotImplementedException = Helper.class({
		...
		__ks_cons_0: function() {
			...
			if(KSType.is(arguments[++__ks_i], AbstractNode)) {
				var node = arguments[__ks_i];
			}
			else throw new Error("Invalid type for parameter 'node'")
		...
		__ks_cons: function(args) {
			if(args.length === 1) {
				...
				if(KSType.is(args[0], this.constructor.__ks_reflect.constructors[1].parameters[1].type)) {
					NotImplementedException.prototype.__ks_cons_1.apply(this, args);
				}
				else {
					if(KSType.is(args[1], this.constructor.__ks_reflect.constructors[0].parameters[1].type)) {
						NotImplementedException.prototype.__ks_cons_0.apply(this, args);
					}
					else {
				...
				if(KSType.is(args[1], this.constructor.__ks_reflect.constructors[1].parameters[1].type)) {
					NotImplementedException.prototype.__ks_cons_1.apply(this, args);
				}
				else {
					NotImplementedException.prototype.__ks_cons_2.apply(this, args);
	...
	NotImplementedException.__ks_reflect = {
		inits: 0,
		constructors: [
			{
				access: 3,
	...
	NotSupportedException.__ks_reflect = {
		inits: 0,
		constructors: [
			{
				access: 3,
	...
	ReferenceException.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	var SyntaxException = Helper.class({
		...
		$static: {
			...
			__ks_sttc_throwMissingAbstractMethods_0: function(name, node) {
				if(name === undefined || name === null) {
					throw new Error("Missing parameter 'name'");
				}
				if(node === undefined || node === null) {
			...
			__ks_sttc_throwNotAbstractClass_0: function(className, methodName, node) {
				...
				if(methodName === undefined || methodName === null) {
					throw new Error("Missing parameter 'methodName'");
				}
				if(node === undefined || node === null) {
					throw new Error("Missing parameter 'node'");
				}
			...
			__ks_sttc_throwNotBinary_0: function(tag, node) {
				if(tag === undefined || tag === null) {
					throw new Error("Missing parameter 'tag'");
				}
				if(node === undefined || node === null) {
					throw new Error("Missing parameter 'node'");
				}
	...
	var $signature = {
		...
		isMatchingParameters: function(p1, p2) {
			...
			if(p2 === undefined || p2 === null) {
				throw new Error("Missing parameter 'p2'");
			}
			...
			if(variable.kind === VariableKind.Class) {
				...
				if(variable.type.types) {
					...
					for(var __ks_0 = 0, __ks_1 = variable.type.types.length, type; __ks_0 < __ks_1; ++__ks_0) {
						...
						var v, __ks_2, __ks_3;
						if(!((KSType.isValue(__ks_2 = $variable.fromType(type, node)) ? (v = __ks_2, true) : false) && (KSType.isValue(__ks_3 = $variable.filterMember(v, name, node)) ? (v = __ks_3, true) : false))) {
							return null;
						}
							...
							if(data.object.kind === NodeKind.Identifier) {
								if(KSType.isValue(variable.classMethods[name])) {
									...
									for(var __ks_1 = 0, __ks_2 = variable.classMethods[name].length, method; __ks_1 < __ks_2; ++__ks_1) {
										...
										if(KSType.isValue(method.type) && KSType.isValue(method.type.typeName)) {
											$variable.push(variables, {
												kind: VariableKind.Variable,
												type: {
													kind: NodeKind.TypeReference,
	...
	Exception.__ks_reflect.constructors[1].parameters[1].type = AbstractNode;
	Exception.__ks_reflect.constructors[2].parameters[1].type = AbstractNode;
	NotImplementedException.__ks_reflect.constructors[0].parameters[1].type = AbstractNode;
	NotImplementedException.__ks_reflect.constructors[1].parameters[1].type = AbstractNode;
	NotSupportedException.__ks_reflect.constructors[0].parameters[1].type = AbstractNode;
	...
	var Attribute = Helper.class({
		...
		$static: {
			...
			__ks_sttc_register_0: function(__ks_class_1) {
				...
				if(!KSType.isClass(__ks_class_1)) {
	...
	var Scope = Helper.class({
		...
		__ks_func_acquireTempName_0: function(statement) {
			...
			if(statement !== null && !KSType.is(statement, Statement)) {
	...
	var Module = Helper.class({
		...
		__ks_cons_0: function(data, compiler, file) {
			...
			if(!KSType.is(compiler, Compiler)) {
				throw new Error("Invalid type for parameter 'compiler'");
			}
			...
			if(this._binary) {
				...
				if(this._dynamicRequirements.length) {
					...
					if(this._dynamicRequirements.length === 1) {
						...
						for(var __ks_1 = 0, __ks_2 = this._dynamicRequirements.length, requirement; __ks_1 < __ks_2; ++__ks_1) {
							requirement = this._dynamicRequirements[__ks_1];
				...
				if(this._dynamicRequirements.length) {
					if(this._options.format.destructuring === "es5") {
						...
						for(var i = 0, __ks_1 = this._dynamicRequirements.length, requirement; i < __ks_1; ++i) {
							requirement = this._dynamicRequirements[i];
							if(i) {
								fragments.push($comma);
							}
				...
				if(this._exportSource.length) {
					...
					nf = false;
					for(var __ks_1 = 0, __ks_2 = this._exportSource.length, src; __ks_1 < __ks_2; ++__ks_1) {
						src = this._exportSource[__ks_1];
						if(nf) {
							fragments.push($code(","));
						}
						else {
	...
	var $sealed = {
		...
		filterType: function(type, name, data, node) {
			...
			if(KSType.isValue(type.typeName)) {
	...
	var $class = {
		abstractMethod: function(node, fragments, statement, signature, parameters, reflect, name) {
			if(node === undefined || node === null) {
				throw new Error("Missing parameter 'node'");
			}
			if(fragments === undefined || fragments === null) {
			...
			if(!KSType.isArray(reflect.abstractMethods[name])) {
				reflect.abstractMethods[name] = [];
			}
			var index = reflect.abstractMethods[name].length;
			reflect.abstractMethods[name].push({
				signature: signature,
				parameters: parameters
			});
		},
		areAbstractMethodsImplemented: function(variable, parent, scope) {
			if(variable === undefined || variable === null) {
				throw new Error("Missing parameter 'variable'");
			}
			if(parent === undefined || parent === null) {
			...
			for(var name in parent.abstractMethods) {
				var methods = parent.abstractMethods[name];
			...
			if(KSType.isValue(parent.extends)) {
		...
		continuous: function(node, fragments) {
			...
			var noinit = KSType.isEmptyObject(node._instanceVariables);
			if(!noinit) {
				noinit = true;
			...
			if(node._es5) {
				...
				if(noinit) {
					...
					for(var name in node._instanceVariables) {
						var field = node._instanceVariables[name];
						if(KSType.isValue(field.data.defaultValue)) {
				...
				for(var name in node._abstractMethods) {
					var methods = node._abstractMethods[name];
					for(var __ks_0 = 0, __ks_1 = methods.length, method; __ks_0 < __ks_1; ++__ks_0) {
						method = methods[__ks_0];
		...
		classMethod: function(node, fragments, statement, signature, parameters, reflect, name) {
			...
			if(!KSType.isArray(reflect.classMethods[name])) {
		...
		hierarchy: function() {
			...
			var node = arguments[++__ks_i];
			if(arguments.length > 2) {
				var hierarchy = arguments[++__ks_i];
			}
			else {
				var hierarchy = [];
			}
		...
		instanceMethod: function(node, fragments, statement, signature, parameters, reflect, name) {
			...
			if(!KSType.isArray(reflect.instanceMethods[name])) {
	...
	var $field = {
		signature: function(data, node) {
			...
			var type;
			if(data.type && (KSType.isValue(__ks_0 = $signature.type(data.type, node.scope())) ? (type = __ks_0, true) : false)) {
				signature.type = type;
			}
			return signature;
		}
	...
	var $helper = {
		analyseType: function() {
			...
			if(!KSType.isValue(type)) {
				...
				var variable, __ks_0;
				if(KSType.isValue(__ks_0 = $variable.fromReflectType(type, node)) ? (variable = __ks_0, true) : false) {
					return {
			...
			if(node._extends) {
				extend = function(node, fragments, ctrl) {
					...
					if(node._extendsVariable.classMethods[name]) {
						...
						ctrl.step().code("else if(" + node._extendsName + "." + name + ")").step().line("return " + node._extendsName + "." + name + ".apply(null, arguments)").done();
		...
		constructor: function(node, fragments, reflect) {
			...
			if(node._extends) {
				extend = function() {
					...
					var constructorName = (KSType.isValue(node._extendsVariable.sealed) ? node._extendsVariable.sealed.extern : false) ? "constructor" : "__ks_cons";
					if(KSType.isValue(ctrl)) {
						ctrl.step().code("else").step().line(node._extendsName + ".prototype." + constructorName + ".call(this, args)").done();
					}
					else {
		...
		methodCheckTree: function(methods, types, index, node, fragments, call, argName, refName, returns) {
			if(methods === undefined || methods === null) {
				throw new Error("Missing parameter 'methods'");
			}
			if(types === undefined || types === null) {
				throw new Error("Missing parameter 'types'");
			}
			if(index === undefined || index === null) {
				throw new Error("Missing parameter 'index'");
			}
			...
			for(var name in types[index + 1].types) {
				...
				for(var __ks_0 = 0, __ks_1 = type.methods.length, i; __ks_0 < __ks_1; ++__ks_0) {
					...
					var method = methods[i].signature;
					nf = true;
				...
				for(var __ks_2 = 0, __ks_3 = usages.length; __ks_2 < __ks_3; ++__ks_2) {
					...
					if(count === 0) {
						...
						for(var __ks_0 = 0, __ks_1 = usage.types.length; __ks_0 < __ks_1; ++__ks_0) {
							...
							__ks_item_1.path.push.apply(__ks_item_1.path, [].concat(type.path));
		...
		signature: function(data, node) {
			...
			for(var __ks_0 = 0, __ks_1 = data.parameters.length, parameter; __ks_0 < __ks_1; ++__ks_0) {
				...
				if(!last || !$method.sameType(type, last.type)) {
					...
					last = {
						type: type,
						min: (parameter.defaultValue || (KSType.isValue(parameter.type) ? parameter.type.nullable : false)) ? 0 : 1,
						max: 1
					};
					...
					if(nf) {
						if(!(parameter.defaultValue || (KSType.isValue(parameter.type) ? parameter.type.nullable : false))) {
							++last.min;
						}
						++last.max;
					}
	...
	var $parameter = {
		type: function(data, node) {
			...
			if(KSType.isValue(data.name)) {
				...
				for(var __ks_0 = 0, __ks_1 = data.modifiers.length, modifier; nf && __ks_0 < __ks_1; ++__ks_0) {
					modifier = data.modifiers[__ks_0];
					if(modifier.kind === ModifierKind.Alias) {
						var variable, __ks_2;
						if(KSType.isValue(__ks_2 = node.getInstanceVariable(name)) ? (variable = __ks_2, true) : false) {
							if(KSType.isValue(variable.type)) {
								return variable.type;
							}
						}
						else if(KSType.isValue(__ks_2 = node.getInstanceVariable("_" + name)) ? (variable = __ks_2, true) : false) {
							if(KSType.isValue(variable.type)) {
								return variable.type;
							}
						}
						else if(KSType.isValue(__ks_2 = node.getInstanceMethod(name)) ? (variable = __ks_2, true) : false) {
							if(KSType.isValue(variable.type)) {
								return variable.type;
							}
						}
	...
	var ClassDeclaration = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			if(KSType.isValue(data.extends)) {
				this._extends = true;
				var __ks_0;
				if(KSType.isValue(__ks_0 = this._scope.getVariable(data.extends.name)) ? (this._extendsVariable = __ks_0, false) : true) {
			...
			for(var __ks_0 = 0, __ks_1 = data.members.length, member; __ks_0 < __ks_1; ++__ks_0) {
				...
				if(__ks_2 === NodeKind.CommentBlock) {
					...
					if(KSType.isValue(member.defaultValue)) {
						if(instance) {
					...
					if($method.isConstructor(member.name.name, this._variable)) {
						...
						if(instance) {
							if(method.statement.isAbstract()) {
								if(this._abstract) {
									if(!KSType.isArray(this._abstractMethods[member.name.name])) {
										this._abstractMethods[member.name.name] = [];
										this._variable.abstractMethods[member.name.name] = [];
									}
									this._abstractMethods[member.name.name].push(method);
									this._variable.abstractMethods[member.name.name].push(signature);
								}
								else {
									SyntaxException.throwNotAbstractClass(this._name, member.name.name, this);
								}
							}
							else {
								if(!KSType.isArray(this._instanceMethods[member.name.name])) {
							...
							if(!KSType.isArray(this._classMethods[member.name.name])) {
			...
			if(this._extends && !this._abstract && !$class.areAbstractMethodsImplemented(this._variable, this._extendsVariable, this._scope)) {
				SyntaxException.throwMissingAbstractMethods(this._name, this);
			}
			if(this._sealed) {
		...
		__ks_func_fuse_0: function() {
			...
			for(var name in this._instanceVariables) {
				...
				if(KSType.isValue(variable.defaultValue)) {
		...
		__ks_func_toStatementFragments_0: function(fragments, mode) {
			...
			var reflect = this._sealed ? $class.sealed(this, fragments) : $class.continuous(this, fragments);
			var __ks_0 = this._classVariables;
			for(var name in __ks_0) {
				var field = __ks_0[name];
				if(KSType.isValue(field.defaultValue)) {
					fragments.newLine().code(this._name + "." + name + " = ").compile(field.defaultValue).done();
				}
			}
	...
	var MethodDeclaration = Helper.class({
		...
		__ks_func_getInstanceMethod_0: function(name) {
			if(name === undefined || name === null) {
				throw new Error("Missing parameter 'name'");
			}
			return this._parent.getInstanceMethod(name);
		},
		getInstanceMethod: function() {
			if(arguments.length === 1) {
				return MethodDeclaration.prototype.__ks_func_getInstanceMethod_0.apply(this, arguments);
			}
			else if(Statement.prototype.getInstanceMethod) {
				return Statement.prototype.getInstanceMethod.apply(this, arguments);
			}
			throw new Error("Wrong number of arguments");
		},
		__ks_func_getInstanceVariable_0: function(name) {
			...
			return this._parent.getInstanceVariable(name);
		},
		getInstanceVariable: function() {
			if(arguments.length === 1) {
				return MethodDeclaration.prototype.__ks_func_getInstanceVariable_0.apply(this, arguments);
			}
			else if(Statement.prototype.getInstanceVariable) {
				return Statement.prototype.getInstanceVariable.apply(this, arguments);
			}
			throw new Error("Wrong number of arguments");
		},
		...
		isAbstract: function() {
			if(arguments.length === 0) {
				return MethodDeclaration.prototype.__ks_func_isAbstract_0.apply(this);
			}
		...
		isMethod: function() {
			if(arguments.length === 0) {
				return MethodDeclaration.prototype.__ks_func_isMethod_0.apply(this);
			}
		...
		__ks_func_toStatementFragments_0: function(fragments, mode) {
			...
			var __ks_1 = this._statements;
			for(var __ks_2 = 0, __ks_0 = __ks_1.length, statement; __ks_2 < __ks_0; ++__ks_2) {
				statement = __ks_1[__ks_2];
	...
	var RequireOrImportDeclaration = Helper.class({
		...
		fuse: function() {
			if(arguments.length === 0) {
				return RequireOrImportDeclaration.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Statement.prototype.fuse) {
				return Statement.prototype.fuse.apply(this, arguments);
			}
	...
	RequireOrImportDeclaration.__ks_reflect = {
		inits: 1,
		constructors: [],
		destructors: 0,
		instanceVariables: {
		...
		__ks_func_analyse_0: function() {
			...
			if(KSType.isValue(this._data.value)) {
				if(!this._scope.hasVariable(this._data.value.name)) {
					...
					if(KSType.isValue(this._data.value.type)) {
						$variable.define(this, this._scope, this._data.value.name, $variable.kind(this._data.value.type), this._data.value.type);
					}
						...
						if(variable.type.typeParameters.length === 1) {
							$variable.define(this, this._scope, this._data.value.name, $variable.kind(variable.type.typeParameters[0]), variable.type.typeParameters[0]);
						}
						else {
							$variable.define(this, this._scope, this._data.value.name, VariableKind.Variable, variable.type.typeParameters);
						}
					}
					else {
						$variable.define(this, this._scope, this._data.value.name, VariableKind.Variable);
					}
			...
			if(KSType.isValue(this._data.index)) {
				if(this._data.declaration || !this._scope.hasVariable(this._data.index.name)) {
					$variable.define(this, this._scope, this._data.index.name, $variable.kind(this._data.index.type), this._data.index.type);
		...
		__ks_func_toStatementFragments_0: function(fragments, mode) {
			...
			if(KSType.isValue(this._expressionName)) {
				...
				if(!this.greatScope().hasVariable(this._expressionName)) {
					line.code($variable.scope(this));
					$variable.define(this, this.greatScope(), this._expressionName, VariableKind.Variable);
				}
		...
		__ks_func_analyse_0: function() {
			...
			if(KSType.isValue(this._data.key)) {
				if(this._data.declaration || !this._scope.hasVariable(this._data.key.name)) {
					$variable.define(this, this._scope, this._data.key.name, $variable.kind(this._data.key.type), this._data.key.type);
	...
	var $function = {
		...
		surround: function(node) {
			...
			while(KSType.isValue(parent) && !(KSType.is(parent, MethodDeclaration) || KSType.is(parent, ImplementClassMethodDeclaration))) {
	...
	var Parameter = Helper.class({
		...
		__ks_func_analyse_0: function() {
			if(this._parent.isMethod()) {
				if(KSType.isValue(this._data.name)) {
					...
					for(var __ks_0 = 0, __ks_1 = this._data.modifiers.length, modifier; nf && __ks_0 < __ks_1; ++__ks_0) {
						...
						if(modifier.kind === ModifierKind.Alias) {
							var variable, __ks_2;
							if(KSType.isValue(__ks_2 = this._parent.getInstanceVariable(name)) ? (variable = __ks_2, true) : false) {
								if(KSType.isValue(variable.type)) {
									this._type = $type.reference(variable.type);
								}
							}
							else if(KSType.isValue(__ks_2 = this._parent.getInstanceVariable("_" + name)) ? (variable = __ks_2, true) : false) {
								if(KSType.isValue(variable.type)) {
									this._type = $type.reference(variable.type);
								}
							}
							else if(KSType.isValue(__ks_2 = this._parent.getInstanceMethod(name)) ? (variable = __ks_2, true) : false) {
								if(KSType.isValue(variable.type)) {
									this._type = $type.reference(variable.type);
								}
							}
				...
				for(var __ks_2 = 0, __ks_0 = this._data.modifiers.length, modifier; __ks_2 < __ks_0; ++__ks_2) {
					modifier = this._data.modifiers[__ks_2];
					if(modifier.kind === ModifierKind.Alias) {
			...
			if(KSType.isValue(this._data.name)) {
				var signature = $function.signatureParameter(this._data, this._scope);
				if(signature.rest) {
					...
					$variable.define(this, this._scope, this._data.name, $variable.kind(this._type), this._type);
				}
			...
			this._nullable = KSType.isValue(this._type) ? this._type.nullable : undefined;
		},
		analyse: function() {
			if(arguments.length === 0) {
		...
		__ks_func_toParameterFragments_0: function(fragments) {
			...
			fragments.compile(this._variable);
			if(this._nullable && !KSType.isValue(this._data.defaultValue) && (this._options.format.parameters === "es6")) {
				fragments.code(" = null");
			}
		},
		...
		__ks_func_analyse_0: function() {
			...
			if(this._variable.kind === VariableKind.Class) {
				...
				for(var __ks_0 = 0, __ks_1 = this._data.properties.length, property; __ks_0 < __ks_1; ++__ks_0) {
					...
					if(__ks_3 === NodeKind.FieldDeclaration) {
						property = new ImplementVariableFieldDeclaration(property, this, this._variable);
					}
					else if(__ks_3 === NodeKind.MethodDeclaration) {
	...
	var ImplementClassFieldDeclaration = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			var signature = $field.signature(this._data, this);
			if(this._instance) {
				this._variable.instanceVariables[this._name] = signature;
			}
			else {
				this._variable.classVariables[this._name] = signature;
			}
		...
		__ks_func_toFragments_0: function(fragments, mode) {
			...
			if(this._instance) {
				...
				fragments.line($runtime.helper(this), ".newField(" + $quote(this._name) + ", " + $helper.type(this._type, this) + ")");
			}
			else {
				throw new NotImplementedException(this);
			}
	...
	var ImplementClassMethodDeclaration = Helper.class({
		...
		__ks_func_analyse_0: function() {
			var name = this._data.name.name;
			if((this._isContructor = ((this._data.name.kind === NodeKind.Identifier) && $method.isConstructor(name, this._variable)))) {
				throw new NotImplementedException(this);
			}
			else if((this._isDestructor = ((this._data.name.kind === NodeKind.Identifier) && $method.isDestructor(name, this._variable)))) {
				throw new NotImplementedException(this);
			}
			else {
				for(var i = 0, __ks_0 = this._data.modifiers.length; this._instance && i < __ks_0; ++i) {
				...
				if(this._data.name.kind === NodeKind.Identifier) {
					...
					if(this._instance) {
						if(!KSType.isArray(this._variable.instanceMethods[name])) {
							this._variable.instanceMethods[name] = [];
						}
						this._variable.instanceMethods[name].push(method);
					}
					else {
						if(!KSType.isArray(this._variable.classMethods[name])) {
							this._variable.classMethods[name] = [];
						}
						this._variable.classMethods[name].push(method);
					}
				}
				else if(this._data.name.kind === NodeKind.TemplateExpression) {
					this._name = $compile.expression(this._data.name, this);
				}
			}
			$variable.define(this, this._scope, {
		...
		__ks_func_toStatementFragments_0: function(fragments, mode) {
			...
			if(this._isContructor) {
				...
				var object = line.newObject();
				object.newLine().code("class: ", KSType.isString(variable.name) ? variable.name : variable.name.name);
	...
	var ImplementClassMethodAliasDeclaration = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			if((this._isContructor = ((data.name.kind === NodeKind.Identifier) && $method.isConstructor(data.name.name, variable)))) {
				...
				if(KSType.isValue(data.arguments)) {
		...
		__ks_func_toStatementFragments_0: function(fragments, mode) {
			...
			var line = fragments.newLine().code($runtime.helper(this), ".", this._instance ? "newInstanceMethod" : "newClassMethod", "(");
			var object = line.newObject();
			object.line("class: ", KSType.isString(variable.name) ? variable.name : variable.name.name);
			if(data.name.kind === NodeKind.TemplateExpression) {
	...
	var ReturnStatement = Helper.class({
		...
		__ks_func_fuse_0: function() {
			if((this._value !== null) && KSType.isValue(this._value.fuse)) {
				this._value.fuse();
			}
		},
		fuse: function() {
	...
	var VariableDeclaration = Helper.class({
		...
		__ks_func_isRooted_0: function() {
			return !this._data.rebindable;
		},
		isRooted: function() {
			if(arguments.length === 0) {
				return VariableDeclaration.prototype.__ks_func_isRooted_0.apply(this);
			}
			else if(Statement.prototype.isRooted) {
				return Statement.prototype.isRooted.apply(this, arguments);
			}
			throw new Error("Wrong number of arguments");
		},
	...
	var VariableDeclarator = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			if(this._data.autotype || this._parent.isRooted()) {
				var type = this._data.type;
				if(!type && this._data.init) {
					type = this._data.init;
				}
				$variable.define(this, this._scope, this._data.name, $variable.kind(this._data.type), type);
			}
			else {
				$variable.define(this, this._scope, this._data.name, $variable.kind(this._data.type), this._data.type);
			}
			this._name = $compile.expression(this._data.name, this);
	...
	var ArrayComprehensionForFrom = Helper.class({
		...
		__ks_func_analyse_0: function() {
			$variable.define(this, this._scope, this._data.loop.variable.name, VariableKind.Variable);
	...
	var ArrayComprehensionForIn = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			if(KSType.isValue(this._data.loop.value)) {
				var variable, __ks_0;
				if((KSType.isValue(__ks_0 = $variable.fromAST(this._data.loop.expression, this)) ? (variable = __ks_0, true) : false) && ((KSType.isValue(variable.type) && KSType.isValue(variable.type.typeName)) ? variable.type.typeName.name === "Array" : false) && (KSType.isValue(variable.type.typeParameters) ? variable.type.typeParameters.length === 1 : false)) {
					$variable.define(this, this._scope, this._data.loop.value.name, $variable.kind(variable.type.typeParameters[0]), variable.type.typeParameters[0]);
				}
				else {
					$variable.define(this, this._scope, this._data.loop.value.name, VariableKind.Variable);
				}
			...
			if(KSType.isValue(this._data.loop.index)) {
				$variable.define(this, this._scope, this._data.loop.index.name, VariableKind.Variable);
	...
	var ArrayComprehensionForOf = Helper.class({
		...
		__ks_func_analyse_0: function() {
			...
			if(KSType.isValue(this._data.loop.key)) {
				$variable.define(this, this._scope, this._data.loop.key.name, VariableKind.Variable);
			...
			if(KSType.isValue(variable.type)) {
				if(variable.type.properties) {
					...
					for(var __ks_0 = 0, __ks_1 = variable.type.types.length, type; __ks_0 < __ks_1; ++__ks_0) {
						type = variable.type.types[__ks_0];
						var v, __ks_2, __ks_3;
						if(!((KSType.isValue(__ks_2 = $variable.fromType(type, node)) ? (v = __ks_2, true) : false) && (KSType.isValue(__ks_3 = $call.filterMember(v, name, data, node)) ? (v = __ks_3, true) : false))) {
							return null;
						}
						$variable.push(variables, v);
					}
	...
	var CallExpression = Helper.class({
		...
		__ks_func_fuse_0: function() {
			...
			if(KSType.isValue(this._callScope)) {
	...
	var CallSealedExpression = Helper.class({
		...
		__ks_func_isComputed_0: function() {
			return KSType.isArray(this._callee);
		},
		isComputed: function() {
			if(arguments.length === 0) {
	...
	var ConditionalExpression = Helper.class({
		...
		fuse: function() {
			if(arguments.length === 0) {
				return ConditionalExpression.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Expression.prototype.fuse) {
				return Expression.prototype.fuse.apply(this, arguments);
			}
	...
	ConditionalExpression.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {
	...
	var SequenceExpression = Helper.class({
		...
		__ks_func_analyse_0: function() {
			this._expressions = Helper.mapArray(this._data.expressions, Helper.vcurry(function(expression) {
				return $compile.expression(expression, this);
			}, this));
		},
		analyse: function() {
			if(arguments.length === 0) {
		...
		fuse: function() {
			if(arguments.length === 0) {
				return SequenceExpression.prototype.__ks_func_fuse_0.apply(this);
			}
			else if(Expression.prototype.fuse) {
				return Expression.prototype.fuse.apply(this, arguments);
			}
	...
	SequenceExpression.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {
	...
	PolyadicOperatorBitwiseAnd.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	PolyadicOperatorBitwiseLeftShift.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	PolyadicOperatorBitwiseOr.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	PolyadicOperatorBitwiseRightShift.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	PolyadicOperatorBitwiseXor.__ks_reflect = {
		inits: 0,
		constructors: [],
		destructors: 0,
		instanceVariables: {},
	...
	$expressions[NodeKind.CallExpression] = function(data, parent, scope) {
		if(data === undefined || data === null) {
			throw new Error("Missing parameter 'data'");
		}
		if(parent === undefined || parent === null) {
	...
	$expressions[NodeKind.MemberExpression] = function(data, parent, scope) {
		if(data === undefined || data === null) {
			throw new Error("Missing parameter 'data'");
		}
		if(parent === undefined || parent === null) {
	...
	$statements[NodeKind.MethodDeclaration] = MethodDeclaration;
	...
	Module.__ks_reflect.constructors[0].parameters[1].type = Compiler;
