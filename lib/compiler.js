...
module.exports = function() {
	...
	var AssignmentOperator = __ks__.AssignmentOperator, BinaryOperator = __ks__.BinaryOperator, ClassModifier = __ks__.ClassModifier, FunctionModifier = __ks__.FunctionModifier, Kind = __ks__.Kind, MemberModifier = __ks__.MemberModifier, MethodModifier = __ks__.MethodModifier, ParameterModifier = __ks__.ParameterModifier, ScopeModifier = __ks__.ScopeModifier, UnaryOperator = __ks__.UnaryOperator, VariableModifier = __ks__.VariableModifier;
	...
	var $type = {
		...
		type: function(data, scope, node) {
			...
			else if(__ks_0 === Kind.ThisExpression) {
				var variable;
				if((Type.isValue(__ks_1 = $variable.fromAST(data, node)) ? (variable = __ks_1, true) : false) && Type.isValue(variable.type)) {
					return variable.type;
				}
