...
module.exports = function() {
			...
			if(this._binary) {
				...
				if(this._dynamicRequirements.length) {
					...
					if(this._dynamicRequirements.length === 1) {
						...
						if(__ks_0 === RequireKind.ExternOrRequire) {
						...
						else if(__ks_0 === RequireKind.RequireOrExtern) {
						...
						else if(__ks_0 === RequireKind.RequireOrImport) {
							fragments.push($code("\tif(Type.isValue(" + requirement.parameter + ")) {\n"));
							if(requirement.extendable) {
								fragments.push($code("\t\treturn [" + requirement.parameter + ", __ks_" + requirement.parameter + "];\n"));
								fragments.push($code("\t}\n"));
						...
						for(var __ks_1 = 0, __ks_2 = this._dynamicRequirements.length, requirement; __ks_1 < __ks_2; ++__ks_1) {
							...
							if(__ks_3 === RequireKind.ExternOrRequire) {
								fragments.push($code("\tif(Type.isValue(" + requirement.name + ")) {\n"));
								if(requirement.extendable) {
							...
							else if(__ks_3 === RequireKind.RequireOrExtern) {
								fragments.push($code("\tif(Type.isValue(" + requirement.parameter + ")) {\n"));
								if(requirement.extendable) {
									fragments.push($code("\t\treq.push(" + requirement.parameter + ", __ks_" + requirement.parameter + ");\n"));
									fragments.push($code("\t}\n"));
							...
							else if(__ks_3 === RequireKind.RequireOrImport) {
								fragments.push($code("\tif(Type.isValue(" + requirement.parameter + ")) {\n"));
								if(requirement.extendable) {
									fragments.push($code("\t\treq.push(" + requirement.parameter + ", __ks_" + requirement.parameter + ");\n"));
									fragments.push($code("\t}\n"));
			...
			for(var __ks_0 = 0, __ks_1 = this._data.declarations.length, declaration; __ks_0 < __ks_1; ++__ks_0) {
				...
				if(__ks_2 === NodeKind.ClassDeclaration) {
					...
					if(Type.isValue(declaration.extends)) {
						var superVar, __ks_3;
						if(Type.isValue(__ks_3 = this._scope.getVariable(declaration.extends.name)) ? (superVar = __ks_3, false) : true) {
				...
				else if(__ks_2 === NodeKind.VariableDeclarator) {
	...
	var $require = {
		define: function(declaration, node) {
