...
module.exports = function() {
	...
	function foobar() {
		...
		if(test("1") && test("2") && test(x = "3")) {
			...
			console.log(Type.isBoolean(x) ? __ks_Boolean._im_toInt(x) : __ks_String._im_toInt(x));
			console.log(__ks_Boolean._im_toInt(y));
		}
		console.log(Type.isString(x) ? __ks_String._im_toInt(x) : __ks_Boolean._im_toInt(x));
		console.log(__ks_Boolean._im_toInt(y));
	}
};