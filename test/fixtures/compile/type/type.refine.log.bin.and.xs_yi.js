...
module.exports = function() {
	...
	foobar.__ks_0 = function() {
		...
		if(test.__ks_0(x = "1") && test.__ks_0(y = 2)) {
			...
			console.log(__ks_Number.__ks_func_toInt_0.call(y));
		}
		else {
			console.log(__ks_String.__ks_func_toInt_0.call(x));
			console.log(Type.isBoolean(y) ? __ks_Boolean.__ks_func_toInt_0.call(y) : __ks_Number.__ks_func_toInt_0.call(y));
		}
		console.log(__ks_String.__ks_func_toInt_0.call(x));
		console.log(Type.isNumber(y) ? __ks_Number.__ks_func_toInt_0.call(y) : __ks_Boolean.__ks_func_toInt_0.call(y));
	};
