...
expect(test(new StructA())).to.equal('object', 'struct-instance')
expect(test(id(new StructA()))).to.equal('object', 'id(struct-instance)')
expect(test(TupleA)).to.equal('any', 'tuple')
expect(test(id(TupleA))).to.equal('any', 'id(tuple)')
expect(test(new TupleA())).to.equal('any', 'tuple-instance')
expect(test(id(new TupleA()))).to.equal('any', 'id(tuple-instance)')
