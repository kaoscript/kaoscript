...
module.exports = function() {
	...
	init.__ks_0 = function(data, builder) {
		...
		for(let __ks_2 = data.block(data.body).statements, __ks_1 = 0, __ks_0 = Helper.length(__ks_2); __ks_1 < __ks_0; ++__ks_1) {
			statement = __ks_2[__ks_1];
			block.statement(statement);
		}
		block.done();
		let source = "";
		for(let __ks_2 = builder.toArray(), __ks_1 = 0, __ks_0 = Helper.length(__ks_2); __ks_1 < __ks_0; ++__ks_1) {
