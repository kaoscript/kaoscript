...
module.exports = function(expect) {
	let foo = (() => {
		return (() => {
			const __ks_rt = (...args) => {
				...
				if(args.length >= 1 && args.length <= 2) {
					if(Helper.isVarargs(args, 0, args.length - 1, t0, pts = [0], 0) && Helper.isVarargs(args, 1, 1, t1, pts, 1) && te(pts, 2)) {
						return __ks_rt.__ks_0.call(this, Helper.getVararg(args, 0, pts[1]), void 0, Helper.getVararg(args, pts[1], pts[2]), void 0, void 0);
					}
			...
			__ks_rt.__ks_0 = (u = null, v = null, x, y = null, z = null) => {
				return [u, v, x, y, z];
			};
			return __ks_rt;
		})();
