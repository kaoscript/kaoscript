...
module.exports = function() {
	var __ks__ = require("../_/_number.ks")();
	var Number = __ks__.Number, __ks_Number = __ks__.__ks_Number;
	var __ks__ = require("../_/_string.ks")();
	var String = __ks__.String, __ks_String = __ks__.__ks_String;
