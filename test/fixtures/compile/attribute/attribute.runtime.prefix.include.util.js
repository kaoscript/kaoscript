...
module.exports = function() {
	...
	__ks_Array.__ks_sttc_same_0 = function(a, b) {
		...
		[__ks_0, __ks_1, __ks_2, __ks_3] = KSHelper.assertLoopBounds(0, "", 0, "", a.length, Infinity, "", 1);
	...
	__ks_Array.__ks_func_append_0 = function(args) {
		let __ks_0, __ks_1, __ks_2, __ks_3;
		[__ks_0, __ks_1, __ks_2, __ks_3] = KSHelper.assertLoopBounds(0, "", 0, "", args.length, Infinity, "", 1);
	...
	__ks_String.__ks_func_capitalize_0 = function() {
		return KSHelper.concatString(this.charAt(0).toUpperCase(), this.substring(1).toLowerCase());
	};
