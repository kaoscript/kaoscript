...
module.exports = function(expect) {
	let foo = Helper.function(function(x, items, y) {
		if(x === void 0 || x === null) {
			x = 24;
		}
		if(y === void 0 || y === null) {
		...
		if(Helper.isVarargs(args, 0, 1, t0, pts = [0], 0) && Helper.isVarargs(args, 0, args.length - 2, t1, pts, 1) && Helper.isVarargs(args, 0, 1, t0, pts, 2) && te(pts, 3)) {
			return fn.call(null, Helper.getVararg(args, 0, pts[1]), Helper.getVarargs(args, pts[1], pts[2]), Helper.getVararg(args, pts[2], pts[3]));
		}
