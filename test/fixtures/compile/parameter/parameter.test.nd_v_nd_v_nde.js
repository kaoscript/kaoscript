...
module.exports = function(expect) {
	let foo = (() => {
		return Helper.function((u = null, v, x = null, y, z = null) => {
			return [u, v, x, y, z];
		}, (that, fn, ...args) => {
			const t0 = () => true;
			...
			if(args.length >= 2 && args.length <= 3) {
				if(Helper.isVarargs(args, 0, args.length - 2, t0, pts = [0], 0) && Helper.isVarargs(args, 1, 1, t1, pts, 1) && Helper.isVarargs(args, 1, 1, t1, pts, 2) && te(pts, 3)) {
					return fn.call(null, Helper.getVararg(args, 0, pts[1]), Helper.getVararg(args, pts[1], pts[2]), void 0, Helper.getVararg(args, pts[2], pts[3]), void 0);
				}
