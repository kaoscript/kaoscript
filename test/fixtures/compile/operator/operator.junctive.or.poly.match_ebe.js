...
module.exports = function() {
	...
	foobar.__ks_0 = function(abilities) {
		if((abilities & AnimalFlags.CanFly) == AnimalFlags.CanFly || (abilities & AnimalFlags.EatsFish) == AnimalFlags.EatsFish || (abilities & AnimalFlags.HasClaws) == AnimalFlags.HasClaws) {
		}
	};
