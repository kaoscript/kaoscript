...
module.exports = function() {
	...
	let Quxbaz = Helper.enum(Number, {});
	function toEnumInstance(x) {
		if(arguments.length < 1) {
			throw new SyntaxError("Wrong number of arguments (" + arguments.length + " for 1)");
		}
		if(x === void 0 || x === null) {
	...
	var Corge = Helper.struct(function() {
		return new Dictionary;
	});
	function toStructInstance(x) {
		if(arguments.length < 1) {
			throw new SyntaxError("Wrong number of arguments (" + arguments.length + " for 1)");
		}
		if(x === void 0 || x === null) {
