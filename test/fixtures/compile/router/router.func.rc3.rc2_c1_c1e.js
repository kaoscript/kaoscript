...
module.exports = function() {
	...
	foobar.__ks_rt = function(that, args) {
		...
		if(Helper.isVarargs(args, 1, args.length - 2, t2, pts = [0], 0)) {
			if(Helper.isVarargs(args, 1, 1, t1, pts, 1) && Helper.isVarargs(args, 1, 1, t1, pts, 2) && te(pts, 3)) {
		...
		if(Helper.isVarargs(args, 3, args.length, t0, pts = [0], 0) && te(pts, 1)) {
			return foobar.__ks_0.call(that, Helper.getVarargs(args, 0, pts[1]));
		}
		throw Helper.badArgs();
	};
