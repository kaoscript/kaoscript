	...
	foobar.__ks_rt = function(that, args) {
		...
		if(args.length === 3) {
			if(t0(args[0])) {
				if(t0(args[1])) {
					if(t0(args[2])) {
						return foobar.__ks_0.call(that, [args[0], args[1]], void 0, void 0, args[2]);
					}
				}
				if(t0(args[2])) {
		...
		if(args.length === 4) {
			if(t0(args[0])) {
				if(t0(args[1])) {
					if(t0(args[2])) {
						if(t0(args[3])) {
							return foobar.__ks_0.call(that, [args[0], args[1], args[2]], void 0, void 0, args[3]);
						}
					}
					if(t0(args[3])) {
		...
		if(args.length === 5) {
			if(t0(args[0]) && t0(args[1])) {
				if(t0(args[2])) {
					if(t0(args[4])) {
						return foobar.__ks_0.call(that, [args[0], args[1], args[2]], args[3], void 0, args[4]);
					}
				}
				if(t0(args[4])) {
		...
		if(args.length === 6) {
			if(t0(args[0]) && t0(args[1]) && t0(args[2]) && t0(args[5])) {
