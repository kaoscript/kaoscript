...
module.exports = function() {
	...
	foobar.__ks_rt = function(that, args) {
			...
			if(t0(args[0])) {
				...
				if(t0(args[1])) {
					...
					if(t0(args[2])) {
						...
						if(t0(args[3]) && t0(args[4])) {
							return foobar.__ks_0.call(that, [args[0], args[1], args[2]], void 0, [args[3], args[4]]);
						}
						throw Helper.badArgs();
					}
					throw Helper.badArgs();
		...
		if(args.length === 6) {
			if(t0(args[0]) && t0(args[1])) {
				...
				if(t0(args[2])) {
					...
					if(t0(args[3]) && t0(args[4]) && t0(args[5])) {
						return foobar.__ks_0.call(that, [args[0], args[1], args[2]], void 0, [args[3], args[4], args[5]]);
					}
					throw Helper.badArgs();
				}
				throw Helper.badArgs();
		...
		if(args.length === 7) {
			if(t0(args[0]) && t0(args[1]) && t0(args[2]) && t1(args[3]) && t0(args[4]) && t0(args[5]) && t0(args[6])) {
