...
module.exports = function() {
	...
	foobar.__ks_rt = function(that, args) {
		...
		if(args.length >= 3) {
			if(Helper.isVarargs(args, 0, args.length - 3, t0, pts = [0], 0) && Helper.isVarargs(args, 1, 1, t0, pts, 1) && Helper.isVarargs(args, 1, 1, t2, pts, 2) && Helper.isVarargs(args, 1, 1, t1, pts, 3) && te(pts, 4)) {
