...
module.exports = function() {
	const __ksType = {
		isWorkingDay: value => value === Weekday.MONDAY || value === Weekday.TUESDAY || value === Weekday.WEDNESDAY || value === Weekday.THURSDAY || value === Weekday.FRIDAY
	};
	...
	isWorkingDay.__ks_0 = function(day) {
		return __ksType.isWorkingDay(day);
	};
