...
module.exports = function() {
	...
	class ClassB extends ClassA {
		...
		__ks_func_foobar_0(value) {
			if(Type.isClassInstance(value, ClassA)) {
	...
	class ClassC extends ClassB {
		...
		__ks_func_foobar_2(value) {
			return true;
		}
		__ks_func_foobar_0(value) {
			if(Type.isClassInstance(value, ClassC)) {
				return this.__ks_func_foobar_2(value);
			}
			return super.__ks_func_foobar_0(value);
		}
		__ks_func_foobar_1(value) {
			...
			return super.__ks_func_foobar_1(value);
		}
		__ks_func_foobar_rt(that, proto, args) {
