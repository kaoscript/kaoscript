...
module.exports = function() {
	...
	const SchoolPerson = Helper.alias((value, cast, filter) => Range.is(value) && Type.isDexObject(value, 1, 0, {kind: variant => {
		...
		if(variant === PersonKind.Teacher) {
			return Type.isDexObject(value, 0, 0, {favorite: value => SchoolPerson.is(value, cast, value => value === PersonKind.Student), card: value => Card.is(value, cast, CardSuit.__ks_eq_Reds)});
		}
		return true;
	}}));
