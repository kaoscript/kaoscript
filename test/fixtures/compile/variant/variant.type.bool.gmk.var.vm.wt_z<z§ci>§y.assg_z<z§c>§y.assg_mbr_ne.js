...
module.exports = function() {
	...
	fooobar.__ks_rt = function(that, args) {
		const t0 = value => Event.is(value, [value => NodeData.is(value, 0, value => value === NodeKind.Identifier || value === NodeKind.ArrayBinding || value === NodeKind.ObjectBinding)], value => value) || Type.isNull(value);
		if(args.length === 1) {
			if(t0(args[0])) {
