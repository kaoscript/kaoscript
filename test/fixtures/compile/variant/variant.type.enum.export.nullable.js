...
module.exports = function() {
	...
	const Room = Helper.alias(value => Type.isDexObject(value, 1, 0, {name: Type.isString}));
	const SchoolPerson = Helper.alias((value, cast, filter) => Type.isDexObject(value, 1, 0, {kind: variant => {
		...
		if(variant === PersonKind.Student) {
			return Type.isDexObject(value, 0, 0, {name: Type.isString, mainRoom: value => Room.is(value) || Type.isNull(value)});
		}
		return true;
	}}));
	return {
