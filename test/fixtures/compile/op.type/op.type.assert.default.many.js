...
module.exports = function() {
	...
	toBoolean.__ks_0 = function(x) {
		return Helper.assertBoolean(x, 0);
	};
	...
	toDictionary.__ks_0 = function(x) {
		return Helper.assertObject(x, 0);
	};
	...
	toFunction.__ks_0 = function(x) {
		return Helper.assertFunction(x, 0);
	};
	...
	toNamespace.__ks_0 = function(x) {
		return Helper.assertNamespace(x, 0);
	};
	...
	toNumber.__ks_0 = function(x) {
		return Helper.assertNumber(x, 0);
	};
	...
	toPrimitive.__ks_0 = function(x) {
		return Helper.assertPrimitive(x, 0);
	};
	...
	toRegExp.__ks_0 = function(x) {
		return Helper.assertRegExp(x, 0);
	};
	...
	toString.__ks_0 = function(x) {
		return Helper.assertString(x, 0);
	};
	...
	toStruct.__ks_0 = function(x) {
		return Helper.assertStruct(x, 0);
	};
	...
	toClassInstance.__ks_0 = function(x) {
		return Helper.assert(x, "\"Foobar\"", 0, value => Type.isClassInstance(value, Foobar));
	};
	...
	toEnumInstance.__ks_0 = function(x) {
		return Helper.assert(x, "\"Quxbaz\"", 0, value => Type.isEnumInstance(value, Quxbaz));
	};
	...
	toStructInstance.__ks_0 = function(x) {
		return Helper.assert(x, "\"Corge\"", 0, value => Type.isStructInstance(value, Corge));
	};
