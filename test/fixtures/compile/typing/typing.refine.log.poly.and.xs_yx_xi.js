...
module.exports = function() {
	...
	foobar.__ks_0 = function() {
		let x = false;
		let y = false;
		if(test.__ks_0(x = "1") && test.__ks_0(y = x) && test.__ks_0(x = 3)) {
			console.log(__ks_Number.__ks_func_toInt_0.call(x));
			console.log(__ks_String.__ks_func_toInt_0.call(y));
		}
		else {
			console.log(Type.isString(x) ? __ks_String.__ks_func_toInt_0.call(x) : __ks_Number.__ks_func_toInt_0.call(x));
